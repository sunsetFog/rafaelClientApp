const config = {
  socketServer: '//im-api-v2.easemob.com/ws',            // xmpp Server地址，对于在console.easemob.com创建的appKey，固定为该值

  apiURL: '//a31.easemob.com',          // rest Server地址，对于在console.easemob.com创建的appkey，固定为该值

  appkey: '1104211013040004#sportlive',        // App key
